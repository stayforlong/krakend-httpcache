module github.com/krakend/krakend-httpcache/v2

go 1.25.3

require (
	github.com/DataDog/dd-trace-go/contrib/redis/go-redis.v9/v2 v2.5.0
	github.com/krakend/httpcache v1.1.0
...
replace github.com/krakend/httpcache v1.1.0 => github.com/stayforlong/httpcache v0.0.0-20260129090018-1f3d9d6e389d
